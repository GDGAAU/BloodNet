    ...
    <>
      ...
      <div className="w-full max-w-[800px] bg-white rounded-lg shadow-lg mx-auto my-10 overflow-hidden">
        <div className="bg-gradient-to-r from-[#9a0036] to-[#67002c] p-5 text-left text-white">
          <h2 className="text-2xl font-bold m-0">Register As Donor</h2>
        </div>

        <form className="p-6 bg-blue-50 bg-opacity-30">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <label className="text-sm font-semibold text-gray-700 md:text-right md:pt-2">Full Name</label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <label className="text-sm font-semibold text-gray-700 md:text-right md:pt-2">Last Name</label>
            <div className="md:col-span-2">
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <label className="text-sm font-semibold text-gray-700 md:text-right md:pt-2">Phone Number</label>
            <div className="md:col-span-2">
              <input
                type="tel"
                placeholder="Number"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <label className="text-sm font-semibold text-gray-700 md:text-right md:pt-2">Blood Group</label>
            <div className="md:col-span-2">
